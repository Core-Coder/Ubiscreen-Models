...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\asus\Envs\Ubiscreen-Model'
    let bin = 'Scripts'
    let path-sep = ';'
    ...
    let virtual-prompt = if ('Ubiscreen-Model' == '') {
...
alias deactivate = source 'C:\Users\asus\Envs\Ubiscreen-Model\Scripts\deactivate.nu'
